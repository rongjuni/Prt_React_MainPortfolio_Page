  ...
  return (
    <div className="aboutMe workExperience bot-mar" id="workExperience">
      ...
      <p>
        ...
        <li>
          Implemented multiple plug-ins including shipping tracker and forms to
          collect users data
        </li>
        <li>
          Improved the websites based on internal / external users feedback
        </li>
        <li>Performed periodic manual testing to make sure everything works</li>
        <li>
          Maintained website and solved issues when the website is not
          functioning as designed
        </li>
        <li>
          Contacted web hosting service provider to request technical support to
          solve issues
        </li>
        <li>
